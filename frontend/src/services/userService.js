...
export async function registerUser(user){
    ...
    try {
        ...
        toast(`Congratulations: ${data.firstName} ${data.lastName}, Your account has been successfully created.`)
...
export async function loginUser(email, password){
    ...
    try {
        ...
        // Send an indication to the user
        toast(`Welcome Back ${data.user.firstName} ${data.user.lastName}.`)
