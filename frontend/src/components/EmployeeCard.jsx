                ...
                context => (
                    <div className="employee-card" id={props._id} >
                        {getCurrentUser().userData.isEditor === true || getCurrentUser().userData.isAdmin === true 
                            ? <div className="card-options" onClick={ () => setMobileOptions( true) }>
                        ...
                        {getCurrentUser().userData.isEditor === true || getCurrentUser().userData.isAdmin === true 
                            ? <div className={`window-options-full-screen ${ mobileOptions ? 'window-options-full-screen-on' : 'window-options-full-screen-off' }`}>
                            <div className="window-options-outline" onClick={ () => setMobileOptions( false) }></div>
                            <div className={`window-options-inline ${ mobileOptions ? 'window-options-inline-on' : 'window-options-inline-off' }`}>
                                    <div className="edit">
                                        <div 
                                            className="tooltip"
                                            onClick={ (e) => 
                        ...
                        <div className="roll">
                            ...
                            <div className="roll-box">
                                {props.roll}
                                <div className="start-date">Start Date {setDateFormat(props.empStartDate)}</div>
                            </div>
                        </div>
